MsgBox @REXTERNAL / @CEL - Loaded, Open Roblox
#NoEnv
...
Process, Priority, %PID%, High
DllCall("QueryPerformanceFrequency", "Int64*", Update)
Msgbox, Dm @55216 if you get any issues.
class JSON
{
...
AimbotKey := config.Rexternal.Binds.Keybind
PauseKey := config.Rexternal.Binds.Pause
Saturation := config.Rexternal.Color.Saturation
LinearCurveX := config.Rexternal.Bezier.LinearCurveX
LinearCurveY := config.Rexternal.Bezier.LinearCurveY
CameraToGunFOV := config.Rexternal.Misc.CameraToGunFOV
AimbotUpdateTick := config.Rexternal.Misc.AimbotUpdateTick
SmoothnessX := config.Rexternal.Easing.SmoothnessX / LinearCurveX
SmoothnessY := config.Rexternal.Easing.SmoothnessY / LinearCurveY
SmoothingReplicatorX := config.Rexternal.Easing.SmoothingReplicatorX
SmoothingReplicatorY := configc.Rexternal.Easing.SmoothingReplicatorY
SmoothingDividerX := config.Rexternal.Easing.SmoothingDividerX
SmoothingDividerY := config.Rexternal.Easing.SmoothingDividerY
FOVOffsetX := config.Rexternal.FOV.FOVOffsetX
FOVOffsetY := config.Rexternal.FOV.FOVOffsetY
FlickTime := config.Rexternal.Misc.FlickTime
AimbotMS := config.Rexternal.Misc.AimbotUpdateMS
Prediction := config.Rexternal.Easing.Prediction.Enabled
PredictionMode := config.Rexternal.Easing.Prediction.Mode
PredictionX := config.Rexternal.Easing.Prediction.PredictionX
PredictionY := config.Rexternal.Easing.Prediction.PredictionY
FallbackPixelX := 0
FallbackPixelY := 0
